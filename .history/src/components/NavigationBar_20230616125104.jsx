...
export default function NavigationBar(){
    ...
    return(
        <nav className=" flex items-center justify-center md:justify-between px-4 sm:px-20 h-16 w-full fixed z-20 bg-darkBlue" 
        >
            ...
            <ul className="flex bottom-0 md:hidden gap-5 uppercase text-blue-300 font-bold">
