...
export default function NavigationBar(){
    ...
    return(
        <nav>
            <div className=" hidden md:flex items-center justify-center md:justify-between px-4 sm:px-20 h-16 w-full fixed  z-20 bg-darkBlue" 
        >
            <div className="w-14 hidden md:flex">
                <img src={logo} alt="logo"/>
            </div>
            <ul className="hidden md:flex gap-16 uppercase text-blue-300 font-bold">
            ...
            <div className="  md:hidden flex items-center justify-center md:justify-between px-4 sm:px-20 h-16 w-full fixed bottom-0 z-20 bg-darkBlue" 
        >
            <ul className="flex  gap-5 uppercase text-blue-300 font-bold">
